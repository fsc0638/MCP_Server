...
def _load_stop_words():
    ...
    # Try multiple paths from project root first, then local fallbacks.
    project_root = Path(__file__).resolve().parents[2]
    candidates = [
        project_root / "Agent_skills" / "shared" / "stop_words.json",
        project_root / "shared" / "stop_words.json",
...
def select_relevant_tools(
    ...
    """
    CORE_TOOLS = {"mcp-python-executor", "mcp-builder", "mcp-skill-builder", "mcp-web-search", "mcp-schedule-manager", "mcp-google-calendar"}
