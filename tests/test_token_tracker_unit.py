...
def test_token_summary_separates_chat_calls(tmp_path: Path):
    ...
    tr.record_usage(session_id="s1", user_id="u1", chat_type="personal", chat_id="", response_id="r1", skill="(chat)", total_tokens=10)
    tr.record_usage(session_id="s1", user_id="u1", chat_type="personal", chat_id="", response_id="r2", skill="get_weather", total_tokens=20)
    tr.record_usage(session_id="s2", user_id="u2", chat_type="group", chat_id="g1", response_id="r3", skill="(chat)", total_tokens=5)
